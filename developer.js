...
// SHA-256 hash function using the browser's built-in Web Crypto API.
// This is a one-way function — the original credential cannot be recovered from the hash.
...
// Stored as SHA-256 hashes. Original credentials are NOT present in this file.
const AUTH_USER_HASH = '99343e5a295a714e06d3ee50df42c8893f7cbb3101c32b2fcea57665fd0b3d13';
const AUTH_PASS_HASH = '031029e5187b4b851d5591b7215878dcf23e2a99cfd0b631c8c1c4145217132e';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Handle Login Form Submit (Hash-based authentication)
  if (loginForm) {
    loginForm.addEventListener('submit', async (e) => {
      e.preventDefault();

      const userInput = devUsernameInput.value.trim().toLowerCase();
      ...
      try {
        // Hash the entered credentials and compare to stored hashes
        ...
        if (loginErrorAlert) {
          loginErrorAlert.hidden = false;
          loginErrorAlert.innerHTML = '<i class="fa-solid fa-triangle-exclamation"></i> Authentication error. Please try again.';
        }
      }
    });
  }
